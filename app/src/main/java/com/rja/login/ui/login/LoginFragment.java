...
public class LoginFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextInputEditText usernameView = view.findViewById(R.id.textInputEditText);
        TextInputEditText passwordView = view.findViewById(R.id.textInputEditText2);
    ...
    private boolean validateUsernameAndPassword(TextInputEditText username, TextInputEditText password){
        ...
        if(passwordText.length() < 3 || passwordText.length() > 25){
            password.setError("Ooops wrong password!! Guess Again!!");
                return false;
        }
